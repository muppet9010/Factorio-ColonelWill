...
local function OnResearchFinished(event)
    ...
    elseif string.find(technology.name, "escape-pod-v2", 0, true) and not global.Mod.escapeTechCompleted then
        ...
        elseif technology.name == "escape-pod-v2-21" then
