...
function Gui.CreateGui(player)
    ...
    GuiUtil.AddElement({parent = statusFrame, name = "biter-info1", type = "label", caption = {"gui-caption.colonelwill-chat-hunts-will-v1-biter-info1-label"}, style = "muppet_bold_text"})
    GuiUtil.AddElement({parent = statusFrame, name = "biter-info2", type = "label", caption = {"gui-caption.colonelwill-chat-hunts-will-v1-biter-info2-label"}, style = "muppet_bold_text"})
